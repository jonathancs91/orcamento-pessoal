...
class Bd {
	...
	getProximoId() { // Verificar se já existe id em Local Storage
	...
	recuperarTodosRegistros() {
		...
		for(let i = 1; i <= id; i++) {
			...
			// Verificar se há ínidices que foram pulados/ removidos, caso positivo, serão pulados
			if(despesa === null) {
				continue
			}			
...
function carregaListaDespesas(despesas = Array(), filtro = false) {
    ...
    */
    ...
    // Percorrer o array despesas, listando cada de forma dinâmica
